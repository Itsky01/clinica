...
class CreateFechasAtencionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fechas_atencion', function (Blueprint $table) {
            $table->id();
            $table->date('fecha');
            $table->unsignedBigInteger('id_profesional'); // campo para llave foranea
            $table->unsignedBigInteger('id_dia'); // campo para llave foranea
    ...
    {
        Schema::dropIfExists('fechas_atencion');
    }
}
